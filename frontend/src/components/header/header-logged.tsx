...
export function HeaderLogged() {
	return (
		<div className="z-10">
			<nav className="h-full bg-green-700 w-[100px] fixed hidden justify-center shadow md:flex">
			...
			<nav className="w-full bg-green-700 h-[100px] fixed bottom-0 flex justify-center shadow md:hidden">
